    ...
    <div>
      ...
      {showSideBar && (
        <div className="fixed bg-white top-20 grid items-between w-6/12 lg:w-52 shadow min-h-screen pt-2 px-2">
          ...
          <div>
            <div style={sideBarStyle.cursorStyle} className="w-full py-2 fw-600 flex my-2 bg-primary text-white rounded-lg">
              <FontAwesomeIcon icon={faGear} className="pr-3 pl-2 text-2xl" />
              Settings
            </div>
            <div
              style={sideBarStyle.cursorStyle}
              className="w-full py-2 fw-600 flex my-2 bg-primary text-white rounded-lg"
