        ...
        <div>
            <div className="min-h-screen fs-500 relative">
                <div className="w-full py-8 bg-white px-4">
                    <p className="text-2xl fw-600 lg:flex items-center">Order ID: <span className="text-primary px-3">orderID</span> <span className="text-xs text-blue-500 bg-light px-2">Ongoing</span></p>
                ...
                <div className="lg:p-5 px-2 py-4">
                    <div>
                        ...
                        <div className="my-5 border-2 border-gray-500 rounded-md">
                    ...
                    <div className="lg:grid-83">
                        ...
                        <div>
                            <div className="bg-white lg:p-6 p-3 mt-8 rounded-md">
                                <div className="flex justify-between border-b border-gray-300 pb-4">
                                    <p className="fw-600">My Order Info</p>
                                </div>
                                <div className="fs-400 fw-500 mt-4">
                                    <div className="flex">
                                        <p className="text-gray-600">Order Id:</p>
                                        <p className="pl-3">ORD-474-0944</p>
                                    </div>
                                    <div className="flex mt-1">
                                        <p className="text-gray-600">Date Ordered:</p>
                                        <p className="pl-3">05/12/22</p>
                                    </div>
                                    <div className="flex mt-1">
                                        <p className="text-gray-600">Delivery Date:</p>
                                        <p className="pl-3">Null</p>
                                    </div>
                                    <div className="flex mt-1">
