...
import { removeCategory } from '../../../../../../redux/actions/ProductAction';
import Spinner from '../../../../../layouts/Spinner';

const DeleteCategoryModal = ({ CloseDelete, category, isAdmin }) => {
        ...
        <div className="fixed font-primary left-0 top-0 w-full h-screen bg-op center-item z-40" onClick={CloseDelete}>
            <div className="bg-white lg:w-5/12 rounded-md  overscroll-none  w-11/12 pt-8 shadow fw-500 scale-ani" onClick={e => e.stopPropagation()}>
                <div className="flex lg:px-6 px-5">
                    ...
                    <div>
                        <p className="fs-700 fw-600 mb-4">Delete Category</p>
                        <p>Are you sure you want to delete this category? All data attached to this category will be permanently removed.</p>
                    </div>
                </div>
