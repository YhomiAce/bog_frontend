...
import { DownloadTableExcel } from "react-export-table-to-excel";import { Tab, Tabs, TabList, TabPanel } from "react-tabs";
                    ...
                    <div className="bg-white lg:p-5 lg:mt-6 mt-6 rounded-lg">
                        ...
                        <TabPanel>
                            <div className="mt-10">
                                <div className="flex items-center">
                                    ...
                                    <DownloadTableExcel
                                        ...
                                        sheet="users"
                                        currentTableRef={ctableRef.current}
                                    >
                            ...
                            <div className="overflow-x-auto">
                                <table className="items-center w-full bg-transparent border-collapse" ref={ctableRef}>
