...
import Chart from "../../assets/UsersChart";
      ...
      <div className=" p-5">
        ...
        <div className="mt-3">
          <div className="lg:grid-4 justify-between fs-500 fw-600">
            <div className="bg-white px-4 py-3 rounded flex justify-between items-center shades">
              ...
              <div className="">
                <img src={require("../images/order.png")} alt="project" className="-bottom-4 relative w-20"/>
              </div>
            </div>
            <div className="bg-white mt-4 lg:mt-0 px-4 py-3 rounded flex justify-between items-center shades">
              ...
              <div className="">
                <img src={require("../images/pend.png")} alt="" className="-bottom-4 relative w-20"/>
              </div>
            </div>
            <div className="bg-white  mt-4 lg:mt-0 px-4 py-3 rounded flex justify-between items-center shades">
              <div>
            ...
            <div className="bg-white  mt-4 lg:mt-0 px-4 py-3 rounded flex justify-between items-center shades">
              ...
              <div className="">
                <img src={require("../images/ongoing.png")} alt="ongoing" className="-bottom-3 left-2 relative w-24" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" fw-600 fs-500 bg-white pt-6 rounded">
          <div className="flex px-5 justify-between">
            <div>
              <p className="fw-600 text-lg">Recent Orders</p>
            </div>
            <div>
                <div class="mr-6 relative mx-auto text-gray-600">
                    <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
                    type="search" name="search order by name" placeholder="Search"/>
          ...
          <div className="bg-white rounded pt-6 px-4">
            <div>
        ...
        <div className="mt-7 lg:grid-74 justify-between">
          ...
          <div className="bg-white px-6 py-6 rounded">
            ...
            <div className="pt-4 text-sm fw-600">
              <div className="flex justify-between items-center">
                ...
                <div>
                  <p className="text-yellow-600">20% Done</p>
                </div>
              </div>
              <div className="flex mt-4 justify-between items-center">
                ...
                <div>
                  <p className="text-blue-600">70% Done</p>
                </div>
              </div>
              <div className="flex mt-4 justify-between items-center">
                <Avatar src={require('../images/profile.png')} />
                ...
                <div>
                  <p className="text-purple-600">40% Done</p>
                </div>
              </div>
              <div className="flex mt-4 justify-between items-center">
                <Avatar src={require('../images/profile.png')} />
                ...
                <div>
                  <p className="text-green-600">90% Done</p>
                </div>
              </div>
            </div>
          </div>
