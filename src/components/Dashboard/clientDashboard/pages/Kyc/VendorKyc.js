        ...
        <div className='w-full '>
            <div className='w-full'>
                <div className='flex lg:w-full w-full overflow-x-auto fs-500 text-center fw-500'>
                    ...
                    {
                        user?.userType === "vendor" || user?.userType === "product_partner" ?
                            <div
            ...
            <div className='mt-6 lg:mt-10'>
                {
                    open === 1 ? <GeneralInfo handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 2 ? <OrganisationInfo handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 3 ? <TaxDetails handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 4 ? <JobExecution handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 5 ? <SupplyCat handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 6 ? <FinanceData handleOpen={handleOpen} tab={open} /> : ""
                }
                {
                    open === 7 ? <UploadDoc handleOpen={handleOpen} tab={open} /> : ""
                }
            </div>
        </div>
    )
