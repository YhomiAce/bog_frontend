...
export const datas =[
    {
        ...
        benefits: [
            {
                0: "Sell your products to clients",
                1: "Render services to clients",
                2: "Flexible team meeting",
                3: "Available for 12 months."
            }
        ]
    },
    {
...
//     }
    ...
    const columns = useMemo(
        () => [
          ...
          {
            Header: "Plan Amount (NGN)",
            accessor: "amount",
            Cell: (props) => `NGN ${formatNumber(props.value)}`
          },
          {
            Header: "Benefits/Priviledges",
            accessor:  'benefits',
            Cell: (props) => <ul className='list-disc'>
                <li>Sell your products to clients</li>
                <li>Render services to clients</li>
                <li>Flexible team meeting</li>
                <li>Available for a stipulated time</li>
            </ul>
          },
          {
            Header: 'Action',
            ...
            Cell: (row) => <Menu placement="left-start" className="w-16">
                              <MenuHandler>
                                <Button className="border-none bg-transparent shadow-none hover:shadow-none text-black"><span className="lg:text-xl"><BsThreeDotsVertical /></span></Button>
                              </MenuHandler>
                              <MenuList className="w-16 bg-gray-100 fw-600 text-black">
                                <MenuItem >Edit Plan</MenuItem>
                                <MenuItem className="bg-red-600 hover:bg-red-500 hover:text-white text-white">Delete Plan</MenuItem>
                              </MenuList>
                            </Menu>,
          },
